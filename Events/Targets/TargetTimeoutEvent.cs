...
{
    [TypeIcon(typeof(TargetTimeoutEvent))] // Choose the type icon. @32x - headers; @16x -ports and fuzzy finder categories. Located in Editor Default Resources.
    [UnitTitle("On Timeout")] // Sets the actual named title of the unit, this is used in the Fuzzy Finder.
    [UnitCategory("Events/Target")] // Sets unit category in Fuzzy Finder. Subfolders are matched and created.
    public class TargetTimeoutEvent : CustomDelegateEvent<UsefulFieldOfViewTarget>
    {
        [DoNotSerialize]
